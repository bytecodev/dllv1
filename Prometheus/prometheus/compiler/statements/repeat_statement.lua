...
return function(self, statement, funcDepth)
    ...
    self:addStatement(self:setRegister(scope, self.POS_REGISTER, self:blockIdExpression(innerBlock.id)), {self.POS_REGISTER}, {}, false);
    ...
    self:addStatement(self:setRegister(scope, self.POS_REGISTER, Ast.OrExpression(Ast.AndExpression(self:register(scope, conditionReg), self:blockIdExpression(finalBlock.id)), self:blockIdExpression(innerBlock.id))), { self.POS_REGISTER }, { conditionReg }, false);
